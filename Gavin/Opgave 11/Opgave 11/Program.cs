            ...
            switch (menu)
            {
                case 1:
                    Console.WriteLine("Januar: Årets første måned, ofte kold og med sne i mange lande. " +
                        "Navnet kommer fra den romerske gud Janus, " +
                        "der havde to ansigter – et der så fremad, og et der så tilbage.");
                    break;
                case 2:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    Console.WriteLine("September: Efterårets begyndelse, bladene begynder at skifte farve. Navnet kommer fra det latinske ord \"septem\", " +
                        "der betyder syv (september var den syvende måned i den gamle romerske kalender).");
                    break;
                case 10:
                    Console.WriteLine("Oktober: Efteråret er i fuld gang, og det kan være blæsende og regnfuldt. Navnet kommer fra det latinske ord \"octo\", " +
                        "der betyder otte.");
                    break;
                case 11:
                    Console.WriteLine("November: En mørk og ofte trist måned, hvor mange tænker på de døde. Navnet kommer fra det latinske ord \"novem\", " +
                        "der betyder ni.");
                    break;
                case 12:
